const Users = require('../models/Users'); // Import User Model Schema
...
module.exports = (router) => {
  ...
  router.get('/checkUsername/:username', (req, res) => {
    ...
    if (!req.params.username) {
      ...
      Users.findOne({ username: req.params.username }, (err, user) => { // Check if connection error was found
        if (err) {
          res.json({ success: false, message: err }); // Return connection error
        } else {
  ...
  router.get('/profile', (req, res) => {
    ...
    Users.findOne({ _id: req.decoded.userId }).select('username email').exec((err, user) => {
  ...
  router.get('/publicProfile/:username', (req, res) => {
    ...
    if (!req.params.username) {
      ...
      Users.findOne({ username: req.params.username }).select('username email').exec((err, user) => {
        // Check if error was found
        if (err) {
